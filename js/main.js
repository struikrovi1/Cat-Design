(function () {
    ...
    function initializePortfolio() {
        var current, next, prev, target, hash, url, page, projectIndex, scrollPosition, projectLength, ajaxLoading = false,
            wrapperHeight, pageRefresh = true,
            content = false,
